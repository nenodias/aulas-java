...
public class TesteFantasma extends JComponent {
	
	private static final ClassLoader LOADER = TesteFantasma.class.getClassLoader(); 
	...
	private static ImageIcon java2sLogo = new ImageIcon(LOADER.getResource("Java.png"));
	...
	public static void main(String args[]) {
		...
		mainFrame.getContentPane().add(new TesteFantasma());
		mainFrame.pack();
